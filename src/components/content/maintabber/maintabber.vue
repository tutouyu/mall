...
<script>
import tabber from '../../common/tabber/tabber.vue';
import tabberItem from "../../common/tabber/tabber-item.vue";
export default{
  components: {
   tabber,
   tabberItem
